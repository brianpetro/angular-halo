...
feature "Project Show Has And Displays Entries Feature Test" do
  ...
  scenario "Displays Entries ID", js: true do
    visit project_path(project.id)
    page.must_have_content e1.id.to_s
    page.wont_have_content e2.id.to_s
  end

  scenario "Displays Entries Title", js: true do
    visit project_path(project.id)
    page.must_have_content "Entry Title Belongs"
    page.wont_have_content "Do Not Display"
  end

  scenario "Displays Entries Summary", js: true do
    visit project_path(project.id)
